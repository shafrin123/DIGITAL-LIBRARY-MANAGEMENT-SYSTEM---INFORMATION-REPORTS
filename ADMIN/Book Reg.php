...
if (isset($_POST['register'])) { 
    $access_no = isset($_POST['access_no']) ? mysqli_real_escape_string($connection, $_POST['access_no']) : ''; 
    $book_name = isset($_POST['name']) ? mysqli_real_escape_string($connection, $_POST['name']) : ''; 
    $author = isset($_POST['author']) ? mysqli_real_escape_string($connection, $_POST['author']) : ''; 
    $price = isset($_POST['price']) ? mysqli_real_escape_string($connection, $_POST['price']) : ''; 

    // Check if the book already exists
    $sql = "SELECT * FROM booksss WHERE access_no='$access_no'";
    ...
    if (mysqli_num_rows($result) > 0) {
        $msg = "<h3 style='color: red;'>⚠ Book already registered!</h3>";
    } else {
        // Insert into books table
        $query = "INSERT INTO booksss (access_no, name, author, price) 
                  VALUES ('$access_no', '$book_name', '$author',  '$price')";
        $query_run = mysqli_query($connection, $query);

        if ($query_run) {
            $msg = "<h3 style='color: green;'>✔ Book Registered Successfully!</h3>";
        } else {
...
<body> 
    ...
    <section class="dashboard">
        ...
        <div class="container">
            <header>Book Registration</header>
                    ...
                    <div class="details personal">
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <input type="text" name="access_no" placeholder="Access No" required>
                            </div>
